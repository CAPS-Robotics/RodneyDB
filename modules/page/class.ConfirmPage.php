...
Are you sure you want to confirm ' . $core->getUserFromId($_GET['id'])['name'] . '\'s account?
<div class="btn-group btn-group-justified">
<a class="btn btn-lg btn-success btn-block" href="?p=confirm&id=' . $_GET['id'] . '&conf">Yes</a>
