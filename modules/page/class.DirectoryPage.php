...
'
<script>
$(\'span.editable\').click(function(){$(this).html(\'<input type="text" class="form-control edit" value="\' + $(this).text() + \'" autofocus autocomplete="off">\');$(\'input.edit\').focusout(function () {/* AJAX GOES HERE */ $(this).replaceWith($(this).val());});});
</script>
';
		echo $content, $script;
