...
'
<script>
$("span.editable").on("click",function(){$(this).html(\'<input type="text" class="form-control edit" value="\'+$(this).text()+\'" autocomplete="off">\');$("input.form-control.edit").focus();$("input.edit").focusout(function(){$(this).replaceWith($(this).val())})})
</script>
';
		echo $content, $script;
