...
class Core {
	...
	public function __construct($mysql) {
		...
		$this->updateParentContactStmt = $this->db->prepare("UPDATE `" . DB_USER_TABLE . "` SET `parentName`=:parentName, `parentEmail`=:parentEmail, `parentPhone`=:parentPhone WHERE `id`=:id");
	...
	public function updateParentContactDetails($id, $parentName, $parentEmail, $parentPhone) {
